...
public class GildedRoseTest {
    ...
    public void QualityNeverOverFifty() {
        Item[] items = new Item[]{
            Item.createItem("Sulfuras, Hand of Ragnaros", 0, 50)
        };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        for (int i = 0; i < items.length; i++) {
    ...
    public void ItemNormal() {
        Item[] items = new Item[]{
            Item.createItem("Elixir of the Mongoose", -1, 20)
        };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        for (int i = 0; i < items.length; i++) {
    ...
    public void AgedBrie() {
        Item[] items = new Item[]{
            Item.createItem("Aged Brie", 3, 14)
    ...
    public void BackstageInfTen() {
        Item[] items = new Item[]{
            Item.createItem("Backstage passes to a TAFKAL80ETC concert", 6, 14)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    public void BackstageInfFive() {
        Item[] items = new Item[]{
            Item.createItem("Backstage passes to a TAFKAL80ETC concert", 5, 14)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    public void BackstageExpired() {
        Item[] items = new Item[]{
            Item.createItem("Backstage passes to a TAFKAL80ETC concert", -1, 14)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    public void BackstageSupTen() {
        Item[] items = new Item[]{
            Item.createItem("Backstage passes to a TAFKAL80ETC concert", 12, 15)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(app.items[0].quality, 16);
    }
    ...
    public void ItemConjured() {
        Item[] items = new Item[]{
            Item.createItem("Conjured Mana Cake", -1, 14)
        };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
